...
import androidx.compose.animation.core.animateDpAsState as animateDpAsState1

 class RecylerActivity : ComponentActivity() {
 ...
 fun ListItem(name:String){
     val expanded= remember { mutableStateOf(false) }
      val  extrapadding by animateDpAsState1(
